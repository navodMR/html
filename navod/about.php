			...
			<div class="upper">
				...
				<!-- End of 2 -->
					...
					<div class="inner-detail-container">
						<!-- -->
						<img src="images/relaxationLogo.jpg" alt="Picture Not Found" id="pictureLogo">
			...
			<div class="container">
				<div class="one">
					...
					<div class="description">
						<h1 class="header">
						Swimming Pool &amp; <span>Jacuzzi</span>
						<span class="title-block"></span>
						</h1>
						<p>
						<!--Perhaps our amoeba shaped temperature controlled largest swimming pool in the country can give you the comfort at your exclusive leisure. Apart from that, two types of temperature controlled children swimming pool will allow your family to enjoy the magnificence of nature.-->
						Perhaps the amoeba shaped, temperature controlled swimming pool, the largest in Sri Lanka, can soothe your tired mind and body after a long day's adventure whilst your children enjoy the 2 smaller children's pools.
						</p>
					</div>
				</div>
				<div class="two">
					...
					<div class="description2">
						...
						<p>
						Relaxation and well being go hand in hand with the image of a pleasurable holiday. Sea Side South Park' Spa and Gym presents you with a world class, fully equipped gym. The Spa offers Thai traditional massage, Aromatherapy massage, Thai Herbal, Swedish and sport massages as well as scrub massages for your relaxation. The Sauna, Steam room, Beauty Parlor and Men's saloon all round off your holistic experience.Apart from spending the leisure time it is necessary to take a good care of health. Sea Side South Park & Golf presents you a world class gymnasium can offer you the relax with lavishness.
						</p>
					</div>
				</div>
...
<h1>Recreations</h1>
						<img src="images/recreationLogo2.jpg"/>
					<div class="description">
						<h1 class="header">
						Outdoor Sports
						<span class="title-block"></span>
				...
				<div class="two">
					...
					<div class="description2">
						...
						<p>
						Pool, table tennis and children playing zone can present you the moment of eventful joy.
						</p>
					</div>
				</div>
				...
				<div class="one">
					<div class="image1" ></div>
						<img src="images/playzoneChildren.jpg"/>
					<div class="description">
						<h1 class="header">
						Children's Playzone
						<span class="title-block"></span>
			...
			<div class="footer">
				...
				<center>Site by <a href="" target="_blank">WEB Blasters</a> <p></p></center>
			</div>
			<!-- End. of Footer -->
